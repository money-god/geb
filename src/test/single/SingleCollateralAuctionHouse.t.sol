...
contract Guy {
    ...
    function approveSAFEModification(bytes32 auctionType, address safe) public {
        ...
        if (auctionType == "english") {
            ...
            safeEngine = address(
                increasingDiscountCollateralAuctionHouse.safeEngine()
            );
        } else {
            safeEngine = address(
                fixedDiscountCollateralAuctionHouse.safeEngine()
            );
        }
    ...
    function try_increaseBidSize(
        ...
        (ok, ) = address(englishCollateralAuctionHouse).call(
            abi.encodeWithSignature(sig, id, amountToBuy, rad)
        );
    }

    function try_buyCollateral(uint id, uint wad) public returns (bool ok) {
        string memory sig = "buyCollateral(uint256,uint256)";
        (ok, ) = address(fixedDiscountCollateralAuctionHouse).call(
            abi.encodeWithSignature(sig, id, wad)
        );
    }

    function try_buyCollateral_increasingDiscount(
        uint id,
        uint wad
    ) public returns (bool ok) {
        string memory sig = "buyCollateral(uint256,uint256)";
        (ok, ) = address(increasingDiscountCollateralAuctionHouse).call(
            abi.encodeWithSignature(sig, id, wad)
        );
    }
    ...
    function try_decreaseSoldAmount(
        ...
        (ok, ) = address(englishCollateralAuctionHouse).call(
            abi.encodeWithSignature(sig, id, amountToBuy, bid)
        );
    }

    function try_settleAuction(uint id) public returns (bool ok) {
        string memory sig = "settleAuction(uint256)";
        (ok, ) = address(englishCollateralAuctionHouse).call(
            abi.encodeWithSignature(sig, id)
        );
    }

    function try_restartAuction(uint id) public returns (bool ok) {
    ...
    function try_english_terminateAuctionPrematurely(
        uint id
    ) public returns (bool ok) {
    ...
    function try_fixedDiscount_terminateAuctionPrematurely(
        uint id
    ) public returns (bool ok) {
        string memory sig = "terminateAuctionPrematurely(uint256)";
        (ok, ) = address(fixedDiscountCollateralAuctionHouse).call(
    ...
    function try_increasingDiscount_terminateAuctionPrematurely(
        uint id
    ) public returns (bool ok) {
        string memory sig = "terminateAuctionPrematurely(uint256)";
        (ok, ) = address(increasingDiscountCollateralAuctionHouse).call(
...
contract DummyLiquidationEngine {
    ...
    function removeCoinsFromAuction(uint rad) public {
        currentOnAuctionSystemCoins = subtract(
...
contract SingleEnglishCollateralAuctionHouseTest is DSTest {
    ...
    function setUp() public {
        ...
        ali = address(
            new Guy(
                ...
                FixedDiscountCollateralAuctionHouse(address(0)),
                IncreasingDiscountCollateralAuctionHouse(address(0))
            )
        );
        bob = address(
            new Guy(
        ...
        Guy(ali).approveSAFEModification(
            "english",
            address(collateralAuctionHouse)
        );
        Guy(bob).approveSAFEModification(
            "english",
            address(collateralAuctionHouse)
        );
    ...
    function test_increase_bid_decrease_sold_same_bidder() public {
        uint id = collateralAuctionHouse.startAuction({
            amountToSell: 100 ether,
    ...
    function test_increase_bid() public {
        ...
        assertEq(
            liquidationEngine.currentOnAuctionSystemCoins(),
            rad(1000 ether) - 50 ether
        );
    ...
    function test_settle_auction() public {
        ...
        uint ie = collateralAuctionHouse.startAuction({
            amountToSell: 100 ether,
            amountToRaise: 50 ether,
            forgoneCollateralReceiver: safeAuctioned,
            auctionIncomeRecipient: auctionIncomeRecipient,
    ...
    function test_terminate_prematurely_increase_bid() public {
        ...
        assertEq(
            safeEngine.token_collateral_balance(address(this)),
            1000 ether
        );
    }
...
contract SingleFixedDiscountCollateralAuctionHouseTest is DSTest {
    ...
    function setUp() public {
        ...
        liquidationEngine = new DummyLiquidationEngine(rad(1000 ether));
        collateralAuctionHouse = new FixedDiscountCollateralAuctionHouse(
            address(safeEngine),
            address(liquidationEngine),
            "collateralType"
        );
        ...
        ali = address(
            new Guy(
                EnglishCollateralAuctionHouse(address(0)),
                collateralAuctionHouse,
                IncreasingDiscountCollateralAuctionHouse(address(0))
            )
        );
    ...
    function test_modifyParameters() public {
        ...
        assertEq(
            collateralAuctionHouse.lowerCollateralMedianDeviation(),
            0.95E18
        );
        assertEq(
            collateralAuctionHouse.upperCollateralMedianDeviation(),
            0.90E18
        );
        assertEq(
            collateralAuctionHouse.lowerSystemCoinMedianDeviation(),
            0.95E18
        );
        assertEq(
            collateralAuctionHouse.upperSystemCoinMedianDeviation(),
            0.90E18
        );
        assertEq(collateralAuctionHouse.minimumBid(), 50 * WAD);
        assertEq(
            uint(collateralAuctionHouse.totalAuctionLength()),
            uint(uint48(-1))
        );
    }
    ...
    function testFail_set_partially_implemented_collateralFSM() public {
        ...
        collateralAuctionHouse.modifyParameters(
            "collateralFSM",
            address(partiallyImplementedCollateralFSM)
        );
    }
    ...
    function test_getSystemCoinFloorDeviatedPrice() public {
        ...
        assertEq(
            collateralAuctionHouse.getSystemCoinFloorDeviatedPrice(
    ...
    function test_getSystemCoinCeilingDeviatedPrice() public {
        ...
        assertEq(
            collateralAuctionHouse.getSystemCoinCeilingDeviatedPrice(
                oracleRelayer.redemptionPrice()
            ),
            oracleRelayer.redemptionPrice()
        );
    ...
    function test_buy_some_collateral() public {
        ...
        uint collateralAmountPreBid = safeEngine.tokenCollateral(
            "collateralType",
            address(ali)
        );
        ...
        (bool canBidThisAmount, uint256 adjustedBid) = collateralAuctionHouse
            .getAdjustedBid(id, 25 * WAD);
        ...
        assertEq(
            ...
            1 ether - 131578947368421052
        );
        assertEq(
            safeEngine.tokenCollateral("collateralType", address(ali)) -
                collateralAmountPreBid,
            131578947368421052
        );
    }
    ...
    function test_buy_all_collateral() public {
        ...
        assertEq(
            collateralAuctionHouse.getDiscountedCollateralPrice(
                200 ether,
                0,
                oracleRelayer.redemptionPrice(),
                0.95E18
        ...
        (
            uint collateralBought,
            uint collateralBoughtAdjustedBid
    ...
    function test_precision_loss_buy_all() public {
        ...
        (bool canBidThisAmount, uint256 adjustedBid) = collateralAuctionHouse
            .getAdjustedBid(id, 100 * WAD);
        Guy(ali).buyCollateral(id, 100 * WAD);
        assertEq(
            liquidationEngine.currentOnAuctionSystemCoins(),
            900000000000000000000000000000000000000000000001
        );
        ...
        assertEq(
            safeEngine.coinBalance(auctionIncomeRecipient),
    ...
    function test_buyCollateral_insignificant_leftover_to_raise() public {
        ...
        assertEq(
            ...
            1 ether - 268421052631578946
        );
    }

    function test_buyCollateral_correctly_update_current_debt_being_auctioned()
        public
    {
        oracleRelayer.modifyParameters("redemptionPrice", RAY);
        collateralFSM.set_val(200 ether);
        ...
        assertEq(
            liquidationEngine.currentOnAuctionSystemCoins(),
            949000000000000000880000000000000000000000000000
        );
        Guy(ali).buyCollateral(id, 50E18);

        assertEq(
            liquidationEngine.currentOnAuctionSystemCoins(),
            948999999999999999999999999999999999999999998766
        );
        ...
        assertEq(
            safeEngine.coinBalance(auctionIncomeRecipient),
            51000000000000000001000000000000000000000000000
        );
        assertEq(
            safeEngine.tokenCollateral(
                "collateralType",
    ...
    function test_buyCollateral_liquidation_starts_with_zero_on_auction()
        public
    {
        liquidationEngine = new DummyLiquidationEngine(
            51000000000000000000000000000000000000000001234
        );
        collateralAuctionHouse.modifyParameters(
            "liquidationEngine",
            address(liquidationEngine)
        ...
        assertEq(
            liquidationEngine.currentOnAuctionSystemCoins(),
            880000000000000000000000001234
        );
        Guy(ali).buyCollateral(id, 50E18);
    ...
    function test_buyCollateral_small_market_price_insignificant_leftover_to_raise()
        public
    {
        collateralFSM.set_val(0.01 ether);
        oracleRelayer.modifyParameters("redemptionPrice", 2 * RAY);
    ...
    function test_collateral_median_higher_than_collateral_fsm_ceiling()
        public
    {
        oracleRelayer.modifyParameters("redemptionPrice", RAY);
        collateralFSM.set_val(200 ether);
    ...
    function test_terminateAuctionPrematurely() public {
        ...
        assertEq(
            ...
            999736842105263157895
        );
        assertEq(
            addition(999736842105263157895, 263157894736842105),
            1000 ether
        );
        assertEq(
            safeEngine.tokenCollateral("collateralType", address(ali)) -
...
contract SingleIncreasingDiscountCollateralAuctionHouseTest is DSTest {
    ...
    function setUp() public {
        ...
        liquidationEngine = new DummyLiquidationEngine(rad(1000 ether));
        collateralAuctionHouse = new IncreasingDiscountCollateralAuctionHouse(
            address(safeEngine),
            address(liquidationEngine),
            "collateralType"
        );
    ...
    function test_buy_leftover_collateral() public {
         ...
         */
        collateralAuctionHouse.modifyParameters("minDiscount", WAD);
        oracleRelayer.modifyParameters("redemptionPrice", RAY);
        collateralFSM.set_val(200 ether);
        safeEngine.mint(ali, 300 * RAD - 200 ether);

        uint id = collateralAuctionHouse.startAuction({
            amountToSell: 1 ether,
            amountToRaise: 300 * RAD,
            forgoneCollateralReceiver: safeAuctioned,
            auctionIncomeRecipient: auctionIncomeRecipient,
            initialBid: 0
        });
        ...
        (
            uint collateralBought,
            uint collateralBoughtAdjustedBid
        ) = collateralAuctionHouse.getCollateralBought(id, 180 * WAD);

        Guy(ali).buyCollateral_increasingDiscount(id, 180 * WAD);
        ...
        assertEq(amountToSell, 1 ether - collateralBought);
        assertEq(amountToRaise, 120 * RAD);
        assertEq(collateralBought, 0.9 ether);
        assertEq(collateralBoughtAdjustedBid, 180 * WAD);

        (
            uint256 _newCollateralBought,
        ...
        assertEq(amountToSell, 0);
        assertEq(amountToRaise, 0);
        assertEq(_newCollateralBought, 1 ether - collateralBought); // ok
        assertEq(_newAdjustedBid, 20 * WAD); // SHOULD be capped to collateral amount
    }
    ...
    function test_modifyParameters() public {
        ...
        assertEq(
            collateralAuctionHouse.perSecondDiscountUpdateRate(),
            RAY - 100
        );
        assertEq(
            collateralAuctionHouse.maxDiscountUpdateRateTimeline(),
            uint256(uint48(-1)) - now - 1
        );
    ...
    function testFail_max_discount_lower_than_min() public {
        collateralAuctionHouse.modifyParameters(
            "maxDiscount",
            collateralAuctionHouse.minDiscount() + 1
        );
    }
    ...
    function test_buy_some_collateral() public {
        ...
        assertEq(
            ...
            now + collateralAuctionHouse.maxDiscountUpdateRateTimeline()
        );
    ...
    function test_system_coin_median_higher_than_redemption_floor() public {
        ...
        assertEq(amountToSell, 1 ether - 121875000000000000);
        assertEq(amountToRaise, 25 * RAD);
    ...
    function test_system_coin_median_lower_than_redemption_ceiling() public {
        ...
        assertEq(amountToSell, 1 ether - 131250000000000000);
        assertEq(amountToRaise, 25 * RAD);
    ...
    function test_system_coin_median_higher_than_redemption_ceiling() public {
        ...
        assertEq(amountToSell, 1 ether - 137500000000000000);
        assertEq(amountToRaise, 25 * RAD);
    ...
    function test_system_coin_median_lower_than_redemption_floor() public {
        ...
        assertEq(amountToSell, 1 ether - 118750000000000000);
        assertEq(amountToRaise, 25 * RAD);
    ...
    function test_system_coin_lower_collateral_median_higher() public {
        ...
        assertEq(amountToSell, 1 ether - 113095238095238095);
        assertEq(amountToRaise, 25 * RAD);
    ...
    function test_system_coin_higher_collateral_median_lower() public {
        ...
        assertEq(amountToSell, 1 ether - 152777777777777777);
        assertEq(amountToRaise, 25 * RAD);
    ...
    function test_system_coin_lower_collateral_median_lower() public {
        ...
        assertEq(amountToSell, 1 ether - 131944444444444444);
        assertEq(amountToRaise, 25 * RAD);
    ...
    function test_system_coin_higher_collateral_median_higher() public {
        ...
        assertEq(amountToSell, 1 ether - 130952380952380952);
        assertEq(amountToRaise, 25 * RAD);
    ...
    function test_terminateAuctionPrematurely() public {
        ...
        assertEq(
            safeEngine.tokenCollateral("collateralType", address(this)),
            999750000000000000000
        );
        assertEq(
            addition(999736842105263157895, 250000000000000000),
            999986842105263157895
        );
        assertEq(
            safeEngine.tokenCollateral("collateralType", address(ali)) -
                collateralAmountPreBid,
    ...
    function test_small_discount_change_rate_bid_after_half_rate_timeline()
        public
    {
        collateralAuctionHouse.modifyParameters(
            "perSecondDiscountUpdateRate",
    ...
    function test_small_discount_change_rate_bid_long_after_rate_timeline()
        public
    {
        collateralAuctionHouse.modifyParameters(
            "perSecondDiscountUpdateRate",
